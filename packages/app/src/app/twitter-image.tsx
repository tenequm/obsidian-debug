    ...
    (
      <div
        style={{
          ...
          backgroundImage: 'linear-gradient(to bottom right, #9333ea, #3b82f6, #9333ea)',
        ...
        >
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: '24px', color: '#ffffff' }}>AI Agents</span>
            </div>
          </div>
          ...
          >
            @obsidiancredit • obsidian.credit
          </p>
        </div>
      </div>
    ),
