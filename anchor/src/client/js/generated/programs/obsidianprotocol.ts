...
export function identifyObsidianprotocolAccount(
  ...
  if (
    ...
    return ObsidianprotocolAccount.Obsidianprotocol;
  }
  throw new Error(
    'The provided account could not be identified as a obsidianprotocol account.'
  );
}
...
export function identifyObsidianprotocolInstruction(
  ...
  if (
    ...
    return ObsidianprotocolInstruction.Close;
  }
  if (
    containsBytes(
      data,
    ...
    return ObsidianprotocolInstruction.Decrement;
  }
  if (
    containsBytes(
      data,
    ...
    return ObsidianprotocolInstruction.Increment;
  }
  if (
    containsBytes(
      data,
    ...
    return ObsidianprotocolInstruction.Initialize;
  }
  if (
    containsBytes(
      data,
    ...
    return ObsidianprotocolInstruction.Set;
  }
  throw new Error(
    'The provided instruction could not be identified as a obsidianprotocol instruction.'
  );
}

export type ParsedObsidianprotocolInstruction<
  TProgram extends string = 'Count3AcZucFDPSFBAeHkQ6AvttieKUkyJ8HiQGhQwe',
> =
  | ({
      instructionType: ObsidianprotocolInstruction.Close;
    } & ParsedCloseInstruction<TProgram>)
  | ({
      instructionType: ObsidianprotocolInstruction.Decrement;
    } & ParsedDecrementInstruction<TProgram>)
  | ({
      instructionType: ObsidianprotocolInstruction.Increment;
    } & ParsedIncrementInstruction<TProgram>)
  | ({
      instructionType: ObsidianprotocolInstruction.Initialize;
    } & ParsedInitializeInstruction<TProgram>)
  | ({
      instructionType: ObsidianprotocolInstruction.Set;
