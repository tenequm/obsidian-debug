...
export type CloseInput<
  ...
  TAccountObsidianprotocol extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountObsidianprotocol>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountObsidianprotocol> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.obsidianprotocol),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountObsidianprotocol>;
...
> = {
  ...
  accounts: {
    ...
    obsidianprotocol: TAccountMetas[1];
  };
